...
class PlanPriseApiController extends Controller
{
  ...
  public function searchMedicaments(Request $request)
  {
    ...
    $medicaments = \App\Models\Medicament::where(
      'denomination',
      'LIKE',
      $query
    )->get(['id as value', 'denomination as label']);
    $old_medicaments = \App\Models\OldMedicament::where(
      'nomMedicament',
      'LIKE',
      $query
    )
    ...
    $bdpm = \App\Models\BdpmCis::where('denomination', 'LIKE', $query)
      ->whereDoesntHave('medicament')
      ->get(['code_cis as value', 'denomination as label']);
    $created = collect();
  ...
  public function index($pp_id = null)
  {
    ...
    return $this->_jsonResponse($this->pp_repository->index($pp_id));
  }
  ...
  {
    return $this->_jsonResponse($this->pp_repository->destroy($pp_id));
  }
